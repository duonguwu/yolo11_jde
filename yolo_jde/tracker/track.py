"""Tracker registration and callback system for YOLO-JDE."""
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    Raises:
        AssertionError: If the tracker_type is not supported.
    ...
    if cfg.tracker_type not in TRACKER_MAP:
        ...
        raise AssertionError(f"Only {supported_trackers} are supported for now, but got '{cfg.tracker_type}'")
...
def on_predict_postprocess_end(predictor: object, persist: bool = False) -> None:
    ...
    for i in range(len(im0s)):
        ...
        # Handle JDE task with embeddings
